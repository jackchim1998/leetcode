...
class UniqueBinarySearchTreeIITest {
    ...
    void example3() {
        ...
        TreeNode[] answers = new TreeNode[]{
                new BinaryTreeBuilder(new Integer[]{1, null, 3, null, null, 2, null}).build(),
                new BinaryTreeBuilder(new Integer[]{1, null, 2, null, null, null, 3}).build(),
                new BinaryTreeBuilder(new Integer[]{2, 1, 3}).build(),
                new BinaryTreeBuilder(new Integer[]{3, 2, null, 1, null, null, null}).build(),
                new BinaryTreeBuilder(new Integer[]{3, 1, null, null, 2, null, null}).build()
        };
        isMatched(roots,answers);
    }
